...
GenericEventMET::GenericEventMET(bool isMC)
{
  isMC_ = isMC;
...
void GenericEventMET::book(TTree* tree)
{
  tree_ = tree;
  ...
  tree_->Branch("met_sumet"     , &met_sumet_     , "met_sumet/D"     );

  tree_->Branch("metMVA_pt"     , &metMVA_pt_     , "metMVA_pt/D"     );
  tree_->Branch("metMVA_phi"    , &metMVA_phi_    , "metMVA_phi/D"     );
  tree_->Branch("metMVA_sumet"  , &met_sumet_     , "metMVA_sumet/D"     );
  ...
  if ( isMC_ )
  {
    ...
    tree_->Branch("metGEN_pt"     , &metGEN_pt_     , "metGEN_pt/D"     );
    tree_->Branch("metGEN_phi"    , &metGEN_phi_    , "metGEN_phi/D"     );
    tree_->Branch("metGEN_sumet"  , &met_sumet_     , "metGEN_sumet/D"     );
...
void GenericEventMET::setBranch(TTree* tree)
{
  tree_ = tree;
  ...
  tree_->SetBranchAddress("met_sumet"     , &met_sumet_     );

  tree_->SetBranchAddress("metMVA_pt"     , &met_pt_     );
  tree_->SetBranchAddress("metMVA_phi"    , &met_phi_     );
  tree_->SetBranchAddress("metMVA_sumet"  , &met_sumet_     );
  ...
  if ( isMC_ )
  {
    ...
    tree_->SetBranchAddress("metGEN_pt"     , &met_pt_     );
    tree_->SetBranchAddress("metGEN_phi"    , &met_phi_     );
    tree_->SetBranchAddress("metGEN_sumet"  , &met_sumet_     );
...
GenericEventMET::~GenericEventMET()
{
  delete muons_pt_ ;
  delete muons_eta_;
  delete muons_phi_;
