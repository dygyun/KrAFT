#ifndef KrAFT_GenericNtuple_GenericEventMET_H
#define KrAFT_GenericNtuple_GenericEventMET_H

#include <vector>
#include "TTree.h"

struct GenericEventMET
{
public:
  GenericEventMET(bool isMC=false);
  ~GenericEventMET();
  void clear();
...
public:
  ...
  double met_pt_, met_phi_, met_sumet_;
  double metMVA_pt_, metMVA_phi_, metMVA_sumet_;
  double metGEN_pt_, metGEN_phi_, metGEN_sumet_;
